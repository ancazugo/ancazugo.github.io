...
This is a short update on the Local Climate Zones (LCZs) classification project. It's a collection of notes and experiments I did last week particularly about using label propagation and other sources of information to increase the number of labels and/or features, namely using OpenStreetMap (OSM) data for labels (with [`osm-rasterizer`](https://github.com/ancazugo/osm-rasterizer)), height data for buildings and a canopy height model (CHM) and label propagation to increase the number of labels.
