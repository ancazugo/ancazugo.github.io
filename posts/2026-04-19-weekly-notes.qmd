...
For reference, this is what the current global LCZ map looks like for Nairobi (same color palette as the other maps), so I think we are on the right track because there's more detail in the built classes in the urban areas. See the yellow areas (lightweight lowrise) in my predictions which are most likely slums, and are not detected as such in the global map.

![Global LCZ map for Nairobi](../assets/images/projects/phd-blog/2026-04-19-week-3.png){width=50% fig-align="center"}
